...
@section('title', "PROFILS EMPLOYEES")
            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="{{ route('admin.employes.index') }}">Page Employées</a>
                        </li>
                        <li><i class='bx bx-chevron-right' ></i></li>
                        <li>
                            <a class="active" href="">Tout Profils</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="table-date">
                <div class="todo">
                    <ul class="todo-list todo-color">
                        ...
                        <style>
                            ...
                            *{
                            ...
                            .card {
                                width: 320px;
                                border-radius: 25px;
                                background-color: var(--color-overlay-befor-after);
                            }
                            ...
                            .overlay {
                                ...
                                height: 100%;
                                width: 100%;
                                background-color: var(--color-bg-overlay-profil);
                            ...
                            .card-image .card-img {
                                ...
                                object-fit: cover;
                                border-radius: 50%;
                                border: 4px solid var(--color-bo);
                                border: 4px solid var(--color-border-card-image);
                            }
                        ...
                        <script src="{{ asset('assets/lib/swiper/script.js') }}"></script>
