    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form method="POST" action="{{ route('auth.nouveau.store') }}" class="sign-up-form">
                    @csrf
                    <h2 class="title">S'inscrire</h2>
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input name="numEmp" type="text" placeholder="Numéro CIN" value="{{ old('numEmp') }}">
                        @error('numEmp') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="input-field">
